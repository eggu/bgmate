...
mixin _$BoardGame {
 ...
 int get bggId; String get name; String get thumbnail; int get minPlayers; int get maxPlayers; int get playingTime; String get description; bool get isInCollection;
...
@override
int get hashCode => Object.hash(runtimeType,bggId,name,thumbnail,minPlayers,maxPlayers,playingTime,description,isInCollection);

@override
String toString() {
  return 'BoardGame(bggId: $bggId, name: $name, thumbnail: $thumbnail, minPlayers: $minPlayers, maxPlayers: $maxPlayers, playingTime: $playingTime, description: $description, isInCollection: $isInCollection)';
}
...
@useResult
$Res call({
 int bggId, String name, String thumbnail, int minPlayers, int maxPlayers, int playingTime, String description, bool isInCollection
});
...
/// Create a copy of BoardGame
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bggId = null,Object? name = null,Object? thumbnail = null,Object? minPlayers = null,Object? maxPlayers = null,Object? playingTime = null,Object? description = null,Object? isInCollection = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int bggId,  String name,  String thumbnail,  int minPlayers,  int maxPlayers,  int playingTime,  String description,  bool isInCollection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BoardGame() when $default != null:
return $default(_that.bggId,_that.name,_that.thumbnail,_that.minPlayers,_that.maxPlayers,_that.playingTime,_that.description,_that.isInCollection);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int bggId,  String name,  String thumbnail,  int minPlayers,  int maxPlayers,  int playingTime,  String description,  bool isInCollection)  $default,) {final _that = this;
switch (_that) {
case _BoardGame():
return $default(_that.bggId,_that.name,_that.thumbnail,_that.minPlayers,_that.maxPlayers,_that.playingTime,_that.description,_that.isInCollection);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int bggId,  String name,  String thumbnail,  int minPlayers,  int maxPlayers,  int playingTime,  String description,  bool isInCollection)?  $default,) {final _that = this;
switch (_that) {
case _BoardGame() when $default != null:
return $default(_that.bggId,_that.name,_that.thumbnail,_that.minPlayers,_that.maxPlayers,_that.playingTime,_that.description,_that.isInCollection);case _:
  return null;
...
class _BoardGame implements BoardGame {
  const _BoardGame({required this.bggId, required this.name, this.thumbnail = '', this.minPlayers = 0, this.maxPlayers = 0, this.playingTime = 0, this.description = '', this.isInCollection = false});
...
/// Create a copy of BoardGame
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bggId = null,Object? name = null,Object? thumbnail = null,Object? minPlayers = null,Object? maxPlayers = null,Object? playingTime = null,Object? description = null,Object? isInCollection = null,}) {
